...
input_dir="${home_dir}/input/trafico"
...
then
	...
	do
		...
		comando="LOAD DATA \
			...
			LINES TERMINATED BY '\n' \
			IGNORE 1 LINES \
			(codigo_llamada, telefono_a, telefono_b, fecha, hora, duracion, cellsite_origen, cellsite_destino, imsi_a, imsi_b, imei_a, imei_b, direccion_llamada) \
			SET id_operadora=1 \
				;"
